...
import { Participant, type IParticipant } from "@/components/participant";
import { TripLink, type ITripLink } from "@/components/trip-link";
...
export function Details({ tripId }: IDetails) {
  ...
  const [links, setLinks] = useState<ITripLink[]>([]);
